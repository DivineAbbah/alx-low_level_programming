...
/**
 * print_array - Prints all contents of an array.
...
/**
 * binary_search_index - Searches for  value in a sorted array using \
 * a binary search.
 ...
 *
 * Return: Outputs the first index of the value in the array, otherwise -1.
 */
